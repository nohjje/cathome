...
### 색상
- 메인 컬러: `#C1694F` (테라코타)
- 보조 메인컬러: `#D4927E` `#F0D5CC`
- 포인트 컬러: `#6B8F71` (세이지 그린)
- 보조 포인트컬러: `#9AB89F` `#D6EBD9`
- 텍스트 색상: `#111111`
- 배경: `#FAF8F5`
...
#### 1. 상단 띠배너
- [x] 주황색 배경 고정 띠 (최상단) (2026-03-27)
- [x] "이번 주 행사 이벤트 모아보기" 텍스트 + 링크 (2026-03-27)

#### 2. 헤더
- [x] 로고 (CATHOME - CAT 파란색, HOME 주황색) (2026-03-27)
- [x] 검색바 (중앙, 돋보기 아이콘) (2026-03-27)
- [x] 우측 아이콘 3개 (알림/장바구니/프로필) (2026-03-27)
- [x] GNB: 카테고리/핫딜/신상품/랭킹/이벤트/체험단/집사커뮤니티 (2026-03-27)
- [x] position: sticky 고정 (2026-03-27)
- [x] 스크롤 시 하단 border/shadow 추가 (2026-03-27)

#### 3. 히어로 슬라이더
- [x] 전체 너비 고양이 이미지 슬라이더 (2026-03-27)
- [x] 좌/우 화살표 버튼 (배경 없는 흰색 chevron, 96px) (2026-03-27)
- [x] 좌하단 슬라이드 카운터 ("1 / 4") (2026-03-27)
- [x] 자동 슬라이드 (4초) (2026-03-27)
- [x] 터치/드래그 스와이프 (2026-03-27)

#### 4. 카테고리 탭 + 아이콘 그리드
- [x] 사료 / 간식 / 용품 탭 (선택 시 주황 배경) (2026-03-27)
- [x] 아이콘 카드 2줄 그리드 (4열) (2026-03-27)
- [x] 각 아이콘 원형 주황 배경 (2026-03-27)
- [x] 상품수 표시 텍스트 (2026-03-27)

#### 5. 핫딜 섹션
- [x] 섹션 타이틀 + 더보기 링크 (2026-03-27)
- [x] 상품 카드 4열 그리드 (이미지/뱃지/상품명/할인율/별점) (2026-03-27)
- [ ] 화살표 버튼 슬라이드 (미구현)

#### 6. 신상품 섹션
- [x] 섹션 타이틀 + 더보기 링크 (2026-03-27)
- [x] 상품 카드 4열 그리드 (2026-03-27)
- [ ] 카드 배경색 변형 (미구현)

#### 7. 나캣랭킹 섹션
- [x] 어코디언 메뉴로 구현 (2026-03-27)
- [x] 1~10위 썸네일 + 상품명 + 클릭 시 상세 펼침 (2026-03-27)
- [x] 1~3위 주황, 4위~ 회색 (2026-03-27)

#### 8. 집사 커뮤니티 섹션
- [x] 2열 2행 카드 그리드 (총 4개) (2026-03-27)
- [x] 썸네일 (16:9, 모서리 16px) / 제목 / 작성자+날짜 (2026-03-27)
- [x] 우하단 고정 채팅 버튼 (2026-03-27)

#### 9. 하단 배너 (3분할)
- [x] 파란 배경 3열 배너 (아이콘 + 텍스트) (2026-03-27)

#### 10. 푸터
- [x] 로고 / SNS 아이콘 3개 / 회사 정보 / 카피라이트 + 정책링크 (2026-03-27)

#### 11. 인터랙션
- [x] 상품·커뮤니티 카드 hover 시 이미지 scale(1.04) 확대 (2026-03-27)
- [x] 버튼 hover/active 색상 변화 (2026-03-27)
- [x] 섹션 스크롤 진입 시 fadeIn 애니메이션 (2026-03-27)
- [x] 상단으로 스크롤 버튼 (스크롤 300px 이후 표시) (2026-03-27)
